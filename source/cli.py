...
Usage:
    uv run python -m source.cli simulate --duration-years 10
    uv run python -m source.cli visualize --data-path output/cr3bp_baseline.parquet
"""
...
def visualize(
    ...
    ] = Path("output/cr3bp_baseline.parquet"),
    output_dir: OutputDir = Path("output/plots"),
    inclination: InclinationDeg = 14.5,
    epoch: Epoch = "2025 JAN 01 00:00:00.0 (UTC)",
) -> None:
