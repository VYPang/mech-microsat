...
_DEFAULT_CONFIG = Path("config/low_inc.json")
...
def _print_orbit_info(epoch_utc: str, inclination_deg: float) -> None:
    ...
    from source.orbit.initial_conditions import compute_l4_state
...
def main(
    ...
    from source.orbit.cr3bp_sim import run_cr3bp_baseline
    from source.orbit.initial_conditions import _ensure_spice_kernels, compute_l4_state
    from source.orbit.rotating_frame import to_rotating_frame
    from source.orbit.visualize import create_all_plots
    ...
    spice.reset()
    import source.orbit.initial_conditions as _ic_mod
