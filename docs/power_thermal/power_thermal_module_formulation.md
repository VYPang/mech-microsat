...
This note is written to match the current optimization scaffold in `source/optimization/sol_sentinel.py`, while also documenting one recommended interface update:
