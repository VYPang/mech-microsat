...
It also identifies which published specifications are required by the fixed-thruster propulsion formulation in `docs/propulsion_fixed_thruster_formulation.md`.
