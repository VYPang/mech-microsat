...
This matches the current optimization scaffold in `source/optimization/sol_sentinel.py`, where Propulsion sits between Orbit and Budget and already exposes the variables:
